...
Chords: props => (
  <Modul
    name="Chords" instruments={[
      {name: "Piano", id: "acoustic-kit/pianochord:chords"},
      {name: "8-Bit Arps", id: "8-bit/arpchord:chords"},
      {name: "Dubstep Synth", id: "dubstep/synthchord:chords"},
      {name: "Cello", id: "hiphop/cello:chords"}
    ]}
    notes={props.notes}
    color={"--color-yellow"}
  />
